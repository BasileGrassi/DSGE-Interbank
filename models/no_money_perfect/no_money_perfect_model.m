...
function [out1,out2,out3,out4,out5] = f(s,x,snext,xnext,p)
    ...
    % f
      ...
      out1(:,3) = -p(14).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)).*(x(:,1) - 1)./(x(:,3).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)))) - x(:,1) + x(:,3);
      out1(:,4) = -p(4).*s(:,1).^(-p(2)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(-1./(p(4) - 1)).*(-p(14).*(-x(:,5).*(x(:,1) - 1) + s(:,1))./x(:,3) + x(:,5).*(-x(:,1) + x(:,3)) + s(:,1).^p(2).*(p(4)./(p(4) - 1)).^(-p(4)).*((1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(1./(p(4) - 1)).*(p(4) - 1)./p(4)).^(-p(4) + 1).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(p(2) + p(4)./(p(4) - 1) - 1).*exp(s(:,2))./(p(4) - 1))./(x(:,3).*(-p(2) + 1).*(p(4) - 1)) + x(:,4);
      out1(:,5) = x(:,5) - (-s(:,1).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))./x(:,3) + s(:,1).^p(2).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(1./(p(4) - 1)).*(-p(2) + 1).*(p(13) + x(:,4).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))./(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)))).*(p(4) - 1)./p(4))./(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)) - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)).*(x(:,1) - 1)./x(:,3));
...
if nargout >= 2
    ...
    % df/ds
      ...
      out2(:,4,1) = p(2).*p(4).*s(:,1).^(-p(2)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(-1./(p(4) - 1)).*(-p(14).*(-x(:,5).*(x(:,1) - 1) + s(:,1))./x(:,3) + x(:,5).*(-x(:,1) + x(:,3)) + s(:,1).^p(2).*(p(4)./(p(4) - 1)).^(-p(4)).*((1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(1./(p(4) - 1)).*(p(4) - 1)./p(4)).^(-p(4) + 1).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(p(2) + p(4)./(p(4) - 1) - 1).*exp(s(:,2))./(p(4) - 1))./(x(:,3).*s(:,1).*(-p(2) + 1).*(p(4) - 1)) - p(4).*s(:,1).^(-p(2)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(-1./(p(4) - 1)).*(p(2).*s(:,1).^p(2).*(p(4)./(p(4) - 1)).^(-p(4)).*((1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(1./(p(4) - 1)).*(p(4) - 1)./p(4)).^(-p(4) + 1).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(p(2) + p(4)./(p(4) - 1) - 1).*exp(s(:,2))./(s(:,1).*(p(4) - 1)) - p(14)./x(:,3))./(x(:,3).*(-p(2) + 1).*(p(4) - 1)); % d eq_4 w.r.t. k
      out2(:,4,2) = -p(4).*(p(4)./(p(4) - 1)).^(-p(4)).*((1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(1./(p(4) - 1)).*(p(4) - 1)./p(4)).^(-p(4) + 1).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(-1./(p(4) - 1)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(p(2) + p(4)./(p(4) - 1) - 1).*exp(s(:,2))./(x(:,3).*(-p(2) + 1).*(p(4) - 1).^2); % d eq_4 w.r.t. z
      out2(:,5,1) = -(p(2).*s(:,1).^p(2).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(1./(p(4) - 1)).*(-p(2) + 1).*(p(13) + x(:,4).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))./(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)))).*(p(4) - 1)./(p(4).*s(:,1)) - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))./x(:,3))./(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)) - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)).*(x(:,1) - 1)./x(:,3)); % d eq_5 w.r.t. k
    ...
    % df/dx
      ...
      out3(:,3,1) = -p(14).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))./(x(:,3).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)))) - 1; % d eq_3 w.r.t. R
      out3(:,3,2) = 0; % d eq_3 w.r.t. c
      out3(:,3,3) = p(14).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)).*(x(:,1) - 1)./(x(:,3).^2.*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)))) + 1; % d eq_3 w.r.t. RL
      out3(:,3,4) = p(14).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)).*(x(:,1) - 1)./(p(13).*x(:,3).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)))) + p(14).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-2./p(12)).*(x(:,1) - 1)./(p(13).*x(:,3).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^2); % d eq_3 w.r.t. nu_def
      out3(:,3,5) = 0; % d eq_3 w.r.t. d
      out3(:,4,1) = -p(4).*s(:,1).^(-p(2)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(-1./(p(4) - 1)).*(p(14).*x(:,5)./x(:,3) - x(:,5))./(x(:,3).*(-p(2) + 1).*(p(4) - 1)); % d eq_4 w.r.t. R
      out3(:,4,2) = 0; % d eq_4 w.r.t. c
      out3(:,4,3) = -p(4).*s(:,1).^(-p(2)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(-1./(p(4) - 1)).*(p(14).*(-x(:,5).*(x(:,1) - 1) + s(:,1))./x(:,3).^2 + x(:,5))./(x(:,3).*(-p(2) + 1).*(p(4) - 1)) + p(4).*s(:,1).^(-p(2)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(-1./(p(4) - 1)).*(-p(14).*(-x(:,5).*(x(:,1) - 1) + s(:,1))./x(:,3) + x(:,5).*(-x(:,1) + x(:,3)) + s(:,1).^p(2).*(p(4)./(p(4) - 1)).^(-p(4)).*((1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(1./(p(4) - 1)).*(p(4) - 1)./p(4)).^(-p(4) + 1).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(p(2) + p(4)./(p(4) - 1) - 1).*exp(s(:,2))./(p(4) - 1))./(x(:,3).^2.*(-p(2) + 1).*(p(4) - 1)); % d eq_4 w.r.t. RL
      out3(:,4,4) = -p(4).*s(:,1).^(-p(2)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(-1./(p(4) - 1)).*(s(:,1).^p(2).*(p(4)./(p(4) - 1)).^(-p(4)).*((1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(1./(p(4) - 1)).*(p(4) - 1)./p(4)).^(-p(4) + 1).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(p(2) + p(4)./(p(4) - 1) - 1).*(-p(4) + 1).*exp(s(:,2))./(p(13).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).*(p(4) - 1).^2) + s(:,1).^p(2).*(p(4)./(p(4) - 1)).^(-p(4)).*((1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(1./(p(4) - 1)).*(p(4) - 1)./p(4)).^(-p(4) + 1).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(p(2) + p(4)./(p(4) - 1) - 1).*(p(2) + p(4)./(p(4) - 1) - 1).*exp(s(:,2))./(p(13).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).*(p(4) - 1)))./(x(:,3).*(-p(2) + 1).*(p(4) - 1)) + 1 + p(4).*s(:,1).^(-p(2)).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(-1./(p(4) - 1)).*(-p(14).*(-x(:,5).*(x(:,1) - 1) + s(:,1))./x(:,3) + x(:,5).*(-x(:,1) + x(:,3)) + s(:,1).^p(2).*(p(4)./(p(4) - 1)).^(-p(4)).*((1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(1./(p(4) - 1)).*(p(4) - 1)./p(4)).^(-p(4) + 1).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(p(2) + p(4)./(p(4) - 1) - 1).*exp(s(:,2))./(p(4) - 1))./(p(13).*x(:,3).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).*(-p(2) + 1).*(p(4) - 1).^2); % d eq_4 w.r.t. nu_def
      out3(:,4,5) = -p(4).*s(:,1).^(-p(2)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(-1./(p(4) - 1)).*(-p(14).*(-x(:,1) + 1)./x(:,3) - x(:,1) + x(:,3))./(x(:,3).*(-p(2) + 1).*(p(4) - 1)); % d eq_4 w.r.t. d
      out3(:,5,1) = -(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)).*(-s(:,1).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))./x(:,3) + s(:,1).^p(2).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(1./(p(4) - 1)).*(-p(2) + 1).*(p(13) + x(:,4).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))./(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)))).*(p(4) - 1)./p(4))./(x(:,3).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)) - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)).*(x(:,1) - 1)./x(:,3)).^2); % d eq_5 w.r.t. R
      out3(:,5,2) = 0; % d eq_5 w.r.t. c
      out3(:,5,3) = -s(:,1).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))./(x(:,3).^2.*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)) - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)).*(x(:,1) - 1)./x(:,3))) + (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)).*(x(:,1) - 1).*(-s(:,1).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))./x(:,3) + s(:,1).^p(2).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(1./(p(4) - 1)).*(-p(2) + 1).*(p(13) + x(:,4).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))./(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)))).*(p(4) - 1)./p(4))./(x(:,3).^2.*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)) - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)).*(x(:,1) - 1)./x(:,3)).^2); % d eq_5 w.r.t. RL
      out3(:,5,4) = -(-(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))./(p(13).*(1 + p(12).*(-p(11) + x(:,4))./p(13))) - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)).*(x(:,1) - 1)./(p(13).*x(:,3).*(1 + p(12).*(-p(11) + x(:,4))./p(13)))).*(-s(:,1).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))./x(:,3) + s(:,1).^p(2).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(1./(p(4) - 1)).*(-p(2) + 1).*(p(13) + x(:,4).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))./(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)))).*(p(4) - 1)./p(4))./(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)) - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)).*(x(:,1) - 1)./x(:,3)).^2 - (s(:,1).^p(2).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(1./(p(4) - 1)).*(-p(2) + 1).*(p(4) - 1).*((1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))./(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))) - x(:,4).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))./(p(13).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)))) - x(:,4).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-2./p(12))./(p(13).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^2))./p(4) + s(:,1).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))./(p(13).*x(:,3).*(1 + p(12).*(-p(11) + x(:,4))./p(13))) + s(:,1).^p(2).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(1./(p(4) - 1)).*(-p(2) + 1).*(p(13) + x(:,4).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))./(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)))).*(p(4) - 1)./(p(13).*p(4).*(1 + p(12).*(-p(11) + x(:,4))./p(13))) + s(:,1).^p(2).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)).*(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))).^(1./(p(4) - 1)).*(-p(2) + 1).*(p(13) + x(:,4).*(1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))./(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12))))./(p(13).*p(4).*(1 + p(12).*(-p(11) + x(:,4))./p(13))))./(1 - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)) - (1 + p(12).*(-p(11) + x(:,4))./p(13)).^(-1./p(12)).*(x(:,1) - 1)./x(:,3)); % d eq_5 w.r.t. nu_def
...
function [out1] = model_info() % informations about the model
    ...
    mod.parameters = { 'beta','alpha','delta','theta','gamma','varphi','rho','sigma_z','sigma_u','spreadq','me','xi','sigma','vartheta','big' };
    mod.shocks = { 'e_z' };
    mod.s_ss = [27.3325 ; 0.0];
    mod.x_ss = [1.00755667506 ; 2.66620400625 ; 1.00755667506 ; -15.2955 ; -0.1628];
    mod.params = [  9.92500000e-01   3.60000000e-01   1.90000000e-02   6.00000000e+00   5.00000000e-01   0.00000000e+00   9.50000000e-01   7.00000000e-03   3.60000000e-03   9.50000000e-03  -3.00000000e+01   9.00000000e-01   2.00000000e-01   9.00000000e-01   5.00000000e+00];
    out1 = mod;
